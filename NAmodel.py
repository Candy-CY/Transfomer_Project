...
class nh_attn_function_set():
    def __init__(self, num_heads, channels, window_size):
        ...
        self.kernel = {}
        self.kernel['nh_attn_forward_q_k'] = self.load_kernel_dtypes('nh_attn_forward_q_k', nh_attn_forward_q_k,
                                                                     self.opt)
        self.kernel['nh_attn_backward_query'] = self.load_kernel_dtypes('nh_attn_backward_query',
                                                                        nh_attn_backward_query, self.opt)
        self.kernel['nh_attn_backward_key'] = self.load_kernel_dtypes('nh_attn_backward_key', nh_attn_backward_key,
                                                                      self.opt)
        self.kernel['nh_attn_backward_bias'] = self.load_kernel_dtypes('nh_attn_backward_bias', nh_attn_backward_bias,
                                                                       self.opt)
        self.kernel['nh_attn_forward_attn_v'] = self.load_kernel_dtypes('nh_attn_forward_attn_v',
                                                                        nh_attn_forward_attn_v, self.opt)
        self.kernel['nh_attn_backward_attn'] = self.load_kernel_dtypes('nh_attn_backward_attn', nh_attn_backward_attn,
                                                                       self.opt)
        self.kernel['nh_attn_backward_value'] = self.load_kernel_dtypes('nh_attn_backward_value',
                                                                        nh_attn_backward_value, self.opt)
